...
public class TaskListAdapter extends RecyclerView.Adapter<TaskListAdapter.ViewHolder>  {
    ...
    public TaskListAdapter(List<TaskModel> myDataset, String userModelSerialized, Context currentActivityContext, Class activityClass) {
        mDataset = myDataset;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View view) {
            super(view);
            mTaskName = (TextView) view.findViewById(R.id.task_item_name);
            mTaskCreationDate = (TextView) view.findViewById(R.id.task_item_creation_date_text);
        ...
        public void onClick(View v) {
            ...
            if (mActivity != null && mContext != null) {
                ...
                intent.putExtra("TASK", Utils.getGsonInstance().toJson(mDataset.get(position)));
