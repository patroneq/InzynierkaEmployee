...
public class WaitingTasksFragment extends Fragment {
    ...
    public WaitingTasksFragment() {
        // Required empty public constructor
    }

    public static WaitingTasksFragment newInstance(String param1, String param2) {
        WaitingTasksFragment fragment = new WaitingTasksFragment();
    ...
    public class GetAllPendingTasksForEmployeeTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            if (getActivity() != null) {
                ...
                String response = new Communication().Receive("/employee/showmywaitingtasks/" + employeeModel.id, "", "GET");
                Log.v("======GSON", response);
